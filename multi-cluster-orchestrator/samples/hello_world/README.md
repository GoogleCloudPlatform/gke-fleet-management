...
You should be familiar with the basics of Terraform. You can use the following
resources:
...
for this tutorial, including [Terraform][8], [kubectl][9], and the [gcloud CLI][10].

> [!WARNING]
> If you do not use Cloud Shell, you may need to install K6 or Docker,
> Terraform, kubectl, and the gcloud CLI. You must also set your default
