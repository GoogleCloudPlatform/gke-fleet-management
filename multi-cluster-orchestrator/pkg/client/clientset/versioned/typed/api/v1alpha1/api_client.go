...
type ApiV1alpha1Interface interface {
	...
	MultiKubernetesClusterBindingsGetter
	MultiKubernetesClusterPlacementsGetter
}
...
func (c *ApiV1alpha1Client) MultiKubernetesClusterBindings(namespace string) MultiKubernetesClusterBindingInterface {
	return newMultiKubernetesClusterBindings(c, namespace)
}

func (c *ApiV1alpha1Client) MultiKubernetesClusterPlacements(namespace string) MultiKubernetesClusterPlacementInterface {
	return newMultiKubernetesClusterPlacements(c, namespace)
}
